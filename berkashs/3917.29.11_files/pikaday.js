    ...
    Pikaday.prototype = {
        ...
        setDate: function(date, preventOnSelect)
        {
            ...
            if(this._d.getDate()<10){
                var tgl_tgl = '0'+this._d.getDate();
            }else{
                var tgl_tgl = this._d.getDate();                
            }

            if((this._d.getMonth()+1)<10){
                var tgl_bln = '0'+(this._d.getMonth()+1);
            }else{
                var tgl_bln = (this._d.getMonth()+1);                
            }

            var tanggal = tgl_tgl+'-'+tgl_bln+'-'+this._d.getFullYear();
            if (this._o.field) {
                this._o.field.value = tanggal;
